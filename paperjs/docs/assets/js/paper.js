...
var paper = function(self, undefined) {
  ...
  var PathItem = Item.extend({
    ...
    getCrossings: function(path) {
      return this.getIntersections(path, (inter) => {
    ...
    return {
      ...
      resolveCrossings: function() {
        ...
        var hasOverlaps = false,
          hasCrossings = false,
          intersections = this.getIntersections(null, (inter) => {
        ...
        if (hasOverlaps) {
          var overlaps = divideLocations(intersections, (inter) => {
  ...
  var Style = Base.extend(new function() {
    ...
    Base.each(groupDefaults, (value, key) => {
  ...
  new function() {
    ...
    function applyAttributes(item, node, isRoot) {
      ...
      Base.each(attributes, (apply, name) => {
  ...
  Base.exports.PaperScript = function() {
    ...
    if (!acorn) {
	  ...
	  if (ch === 92) {
		  ...
		  case 48: out += '\0'; break;
		  case 13: if (input.charCodeAt(tokPos) === 10) {
                  ++tokPos;
                }
		  case 10:
                  if (options.locations) {
      ...
      function handleExports(node) {
        ...
        case 'ExportNamedDeclaration':
          ...
          if (declaration) {
            ...
            var exports = specifiers.map((specifier) => {
