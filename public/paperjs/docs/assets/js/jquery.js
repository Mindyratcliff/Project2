...
(function(e,t){
    var n,r,i=typeof t,o=e.location,a=e.document,s=a.documentElement,l=e.jQuery,u=e.$,c={},p=[],f='1.10.1',d=p.concat,h=p.push,g=p.slice,m=p.indexOf,y=c.toString,v=c.hasOwnProperty,b=f.trim,x=function(e,t){
        ...
        var n,r,i,o,a,s,l,u,c,p,f,d,h,g,m,y,v,b='sizzle'+-new Date,w=e.document,T=0,C=0,N=lt(),k=lt(),E=lt(),S=!1,A=function(){
            ...
            e=e.split('|');var r,i=e.length,a=n?null:t;while(i--){
            ...
            var n=e?e.ownerDocument||e:w,i=n.parentWindow;return n!==f&&9===n.nodeType&&n.documentElement?(f=n,d=n.documentElement,h=!s(n),i&&i.frameElement&&i.attachEvent('onbeforeunload',()=> {
                p();
            }),r.attributes=ct((e)=> {
                return e.innerHTML='<a href=\'#\'></a>',pt('type|href|height|width',dt,'#'===e.firstChild.getAttribute('href')),pt(B,ft,null==e.getAttribute('disabled')),e.className='i',!e.getAttribute('className');
            }),r.input=ct((e)=> {
                return e.innerHTML='<input>',e.firstChild.setAttribute('value',''),''===e.firstChild.getAttribute('value');
            }),pt('value',ht,r.attributes&&r.input),r.getElementsByTagName=ct((e)=> {
                return e.appendChild(n.createComment('')),!e.getElementsByTagName('*').length;
            }),r.getElementsByClassName=ct((e)=> {
            ...
            },m=[],g=[],(r.qsa=st(n.querySelectorAll))&&(ct((e)=> {
            ...
            })),(r.matchesSelector=st(y=d.webkitMatchesSelector||d.mozMatchesSelector||d.oMatchesSelector||d.msMatchesSelector))&&ct((e)=> {
            ...
            var n,r=!e[5]&&e[2];return Q.CHILD.test(e[0])?null:(e[3]&&e[4]!==t?e[2]=e[4]:r&&J.test(r)&&(n=bt(r,!0))&&(n=r.indexOf(')',r.length-n)-r.length)&&(e[0]=e[0].slice(0,n),e[2]=r.slice(0,n)),e.slice(0,3));
            ...
            var t=N[e+' '];return t||(t=RegExp('(^|'+P+')'+e+'('+P+'|$)'))&&N(e,(e)=> {
            ...
            var n,r=o.pseudos[e]||o.setFilters[e.toLowerCase()]||at.error('unsupported pseudo: '+e);return r[b]?r(t):r.length>1?(n=[e,e,'',t],o.setFilters.hasOwnProperty(e.toLowerCase())?ut((e,n)=> {
            ...
            var t=[],n=[],r=l(e.replace(z,'$1'));return r[b]?ut((e,t,n,i)=> {
            ...
            return r&&!r[b]&&(r=Nt(r)),i&&!i[b]&&(i=Nt(i,o)),ut((o,a,s,l)=> {
                var u,c,p,f=[],d=[],h=a.length,g=o||St(t||'*',s.nodeType?[s]:s,[]),m=!e||!o&&t?g:Ct(g,f,e,s,l),y=n?i||(o?e:h||r)?[]:a:m;if(n&&n(m,y,s,l),r){
            ...
            var t,n,r,i=e.length,a=o.relative[e[0].type],s=a||o.relative[' '],l=a?1:0,c=wt((e)=> {
                    return e===t;
                },s,!0),p=wt((e)=> {
                    return F.call(t,e)>-1;
            ...
            var a,s,u,c,p,f=bt(e);if(!i&&1===f.length){
        ...
        var t=O[e]={};return x.each(e.match(T)||[],(e,n)=> {
            t[n]=!0;
        }),t;
        ...
        var t=[['resolve','done',x.Callbacks('once memory'),'resolved'],['reject','fail',x.Callbacks('once memory'),'rejected'],['notify','progress',x.Callbacks('memory')]],n='pending',r={state:function(){
            ...
            var a=o[2],s=o[3];r[o[1]]=a.add,s&&a.add(()=> {
                n=s;
        ...
        var n,r,o,s,l,u,c,p,f,d=a.createElement('div');if(d.setAttribute('className','t'),d.innerHTML='  <link/><table></table><a href=\'/a\'>a</a><input type=\'checkbox\'/>',n=d.getElementsByTagName('*')||[],r=d.getElementsByTagName('a')[0],!r||!r.style||!n.length){
            ...
            t.deleteExpando=!1;
        }o=a.createElement('input'),o.setAttribute('value',''),t.input=''===o.getAttribute('value'),o.value='t',o.setAttribute('type','radio'),t.radioValue='t'===o.value,o.setAttribute('checked','t'),o.setAttribute('name','t'),l=a.createDocumentFragment(),l.appendChild(o),t.appendChecked=o.checked,t.checkClone=l.cloneNode(!0).cloneNode(!0).lastChild.checked,d.attachEvent&&(d.attachEvent('onclick',()=> {
            t.noCloneEvent=!1;
        ...
        var n=t+'queueHooks';return x._data(e,n)||x._data(e,n,{empty:x.Callbacks('once memory').add(()=> {
        ...
        var n=typeof e,r='boolean'===typeof t;return x.isFunction(e)?this.each(function(n){
            ...
            if('string'===n){
                var o,a=0,s=x(this),l=t,u=e.match(T)||[];while(o=u[a++]){
        ...
        var n,r,i,o=this[0];{if(arguments.length){
            return i=x.isFunction(e),this.each(function(n){
                var o;1===this.nodeType&&(o=i?e.call(this,n,x(this).val()):e,null==o?o='':'number'===typeof o?o+='':x.isArray(o)&&(o=x.map(o,(e)=> {
                    return null==e?'':e+'';
        ...
        return x.nodeName(this,'form')?!1:(x.event.add(this,'click._submit keypress._submit',(e)=> {
            var n=e.target,r=x.nodeName(n,'input')||x.nodeName(n,'button')?n.form:t;r&&!x._data(r,'submitBubbles')&&(x.event.add(r,'submit._submit',(e)=> {
                e._submit_bubble=!0;
        ...
        })),!1):(x.event.add(this,'beforeactivate._change',(e)=> {
        ...
        var r=t[0];return n&&(e=':not('+e+')'),1===t.length&&1===r.nodeType?x.find.matchesSelector(r,e)?[r]:[]:x.find.matches(e,x.grep(t,(e)=> {
            return 1===e.nodeType;
        }));
    },dir:function(e,n,r){
        ...
        return this.map(function(){
            ...
            var n=x(this).val();return null==n?null:x.isArray(n)?x.map(n,(e)=> {
        ...
        var o={},a=e===jn;function s(l){
            var u;return o[l]=!0,x.each(e[l]||[],(e,l)=> {
    ...
    }:In,Rn=x.ajaxSettings.xhr(),x.support.cors=!!Rn&&'withCredentials'in Rn,Rn=x.support.ajax=!!Rn,Rn&&x.ajaxTransport((n)=> {
        ...
        var r,i,o=0,a=Gn.length,s=x.Deferred().always(()=> {
                delete l.elem;
            }),l=function(){
                if(i){
                    return!1;
        ...
        })),1===e.nodeType&&('height'in t||'width'in t)&&(n.overflow=[p.overflow,p.overflowX,p.overflowY],'inline'===x.css(e,'display')&&'none'===x.css(e,'float')&&(x.support.inlineBlockNeedsLayout&&'inline'!==ln(e.nodeName)?p.zoom=1:p.display='inline-block')),n.overflow&&(p.overflow='hidden',x.support.shrinkWrapBlocks||u.always(()=> {
    ...
    }x.each({slideDown:ir('show'),slideUp:ir('hide'),slideToggle:ir('toggle'),fadeIn:{opacity:'show'},fadeOut:{opacity:'hide'},fadeToggle:{opacity:'toggle'}},(e,t)=> {
        ...
        x.each({padding:'inner'+e,content:n,'':'outer'+e},(r,i)=> {
            x.fn[i]=function(i,o){
                var a=arguments.length&&(r||'boolean'!==typeof i),s=r||(i===!0||o===!0?'margin':'border');return x.access(this,(n,r,i)=> {
